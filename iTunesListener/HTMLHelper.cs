...
namespace iTunesListener
{
    static class HTMLHelper
    {
        ...
        public static async Task<List<string>> GetImages(string searchingKeyword, string regexPattern = "<img.+?src=[\"'](.+?)[\"'].+?>")
        {
            var url = $@"https://www.google.co.th/search?q={searchingKeyword.Replace(' ', '+').Replace('&', '-')}&source=lnms&tbm=isch&sa=X&ved=0ahUKEwjl0-jRz8zZAhUIjJQKHRhpAwQQ_AUICigB&biw=1065&bih=557";
